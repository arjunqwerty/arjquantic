     ...
     function z(D, u, e) {
        for (var t; D && D !== u;) {
            if (t = D._next || D.nextSibling) {
                return t.textContent.charAt(0) === e; D = D.parentNode || D._parent
            }
        }
    }
    function A(D) {
            ...
            for (s = 0; s < r; s++) {
                if (d = (l = o[s]).parentNode === D, "BR" !== l.nodeName) {
                    if (G && (f = l.style, P || d || (l._x += l.parentNode._x, l._y += l.parentNode._y), f.left = l._x + "px", f.top = l._y + "px", f.position = "absolute", f.display = "block", f.width = l._w + 1 + "px", f.height = l._h + "px"), !P && q) {
                        if (l._isSplit) {
                            for (l._next = E = l.nextSibling, l.parentNode.appendChild(l); E && 3 === E.nodeType && " " === E.textContent;) {
                        ...
                        l.parentNode._isSplit && !l._isSplit && "" !== l.innerHTML ? H.push(l) : q && !l._isSplit && ("span" === M && (l.style.display = "inline"), O.push(l));
                    }
                }
                else {
                    k || G ? (l.parentNode && l.parentNode.removeChild(l), o.splice(s--, 1), r--) : P || D.appendChild(l);
                    for (s = K.length; -1 < --s;) {
        ...
        if (k) {
            ...
            for (h = " " === j && (!G || !P && !q), s = 0; s < k.length; s++) {
                for (a = k[s], (c = X.createElement(M)).style.cssText = "display:block;text-align:" + W + ";position:" + (G ? "absolute;" : "relative;"), I && (c.className = I + (J ? s + 1 : "")), V.push(c), r = a.length, E = 0; E < r; E++) {
                    "BR" !== a[E].nodeName && (l = a[E], c.appendChild(l), h && l._wordEnd && c.appendChild(X.createTextNode(" ")), G && (0 === E && (c.style.top = l._y + "px", c.style.left = v + m + "px"), l.style.top = "0px", m && (l.style.left = l._x - m + "px"))); 0 === r ? c.innerHTML = "&nbsp;" : P || q || (A(c), x(c, String.fromCharCode(160), " ")), G && (c.style.width = g, c.style.height = l._h + "px"), D.appendChild(c)
                }
            } D.style.cssText = f
